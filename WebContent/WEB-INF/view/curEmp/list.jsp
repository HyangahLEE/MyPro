...
<script>
 $(function (){    
   $('#searchBtn').click(function (){
      $('form:first').attr('action','curEmp_list.do');
		...
		<div class="row">
			...
			<div class="col-lg-9 mb-4">
				...
				<div id="wrapper">
					...
					<!--탭 메뉴 영역 -->
					<ul class="tabs">
						<li><a href="hire_list.do">채용정보</a></li>
						<li><a href="curEmp_list.do" style="background-color: white">취업현황</a></li>
					</ul>
							...
							<table class="table table-hover" border="1">
								...
								<thead>
									<tr class="table-primary" style="background-color: #343a40;"
										align="center">
										<td scope="col" style="width: 75px;">글번호</td>
										<td scope="col" style="width: 75px;">이름</td>
										<td scope="col">교육과정</td>
										<td scope="col">개강일</td>
										<td scope="col">종료일</td>
										<td scope="col">취업업체명</td>
										<td scope="col">취업분야</td>
									</tr>
								</thead>
								<tbody>
									...
									<c:if test="${ not empty list }">
										<c:forEach items="${ list }" var="dto">
											...
											<tr align="center">
												<td style="vertical-align: middle;">${ dto.ceid }</td>
												<td style="vertical-align: middle;">${ dto.mname }</td>
												<td style="vertical-align: middle;">${ dto.tpname }</td>
												<td style="vertical-align: middle;">${ dto.adminstart }</td>
												<td style="vertical-align: middle;">${ dto.adminend }</td>
												<td style="vertical-align: middle;">${ dto.cecname }</td>
												<td style="vertical-align: middle;">${ dto.cecurrfield }</td>
											</tr>
									...
									<c:if test="${not empty sessionScope.admin }">
										<div style="position: absolute; right: 10px;">
											<input type="button" value="글쓰기"
												onclick="location.href='curEmp_write.do'" />
										</div>
									</c:if>
									...
									<tr>
										<td><select class="custom-select" id="searchCondition"
											...
											style="margin-left: 220px; width: 100px;">
												<option value="mname"
													${ param.searchCondition eq "mname" ? "selected" : "" }>이름</option>
												<option value="ceid"
													${ param.searchCondition eq "ceid" ? "selected" : "" }>글번호</option>
