  ...
  <li class="breadcrumb-item active">${title }</li>
      ...
      <div class="row">
        ...
        <div class="col-lg-9 mb-4">
            <form action="/incumbentA.do" name="formV" id="formV" method="post">
                ...
                <div style="text-align: center; margin-bottom: 20px;">
                    <button style="margin-right: 10px; width: 120px; height: 40px;" onclick="javascript:applyBnt('${userId}')" class="btn btn-danger">신청하기</button>
                    <button style="margin-right: 10px; width: 120px; height: 40px;" onclick="javascript:lookupBnt();" class="btn btn-primary">수강료조회</button>
                    <button style="width: 120px; height: 40px;"onclick="javascript:history.back();" class="btn">뒤로가기</button>
                </div>
         </div>
      </div>
      <!-- /.row -->
