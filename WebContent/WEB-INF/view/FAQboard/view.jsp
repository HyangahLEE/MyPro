...
<body>
	...
	<div class="container">
		...
		<div class="row">
         ...
         <td width="330">${ dto.faqnum }</td> --%>
						<td width="70" align="center">구분</td>
						<td width="330">${ dto.faqdname }</td>
					</tr>
					<tr>
						<td width="70" align="center">조회수</td>
						<td width="330">${ dto.faqreaded }</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td width="330">${ dto.faqwritedt }</td>
					</tr>
					<tr>
						<td width="70" align="center">글제목</td>
						<td width="330">${ dto.faqtitle }</td>
					</tr>
					<tr>
						<td width="70" align="center">글내용</td>
						<td width="330">
							<div style="width: 100%; height: 200px;">${ dto.faqcontent }
							</div>
						</td>
					</tr>
					<tr>
						<td colspan="2" align="right"><c:if
								...
								<input type="button" value="글수정"
									onclick="location.href='faq_edit.do?faqnum=${ dto.faqnum }&page=${ param.page }&searchCondition=${ param.searchCondition }&searchWord=${ param.searchWord }'">

								<input type="button" id="btnModalDelete" data-toggle="modal" data-target="#exampleModalCenter"
									value="글삭제">
							</c:if> <input type="button" value="글목록"
							onclick="location.href='faq_list.do?page=${ param.page }&searchCondition=${ param.searchCondition }&searchWord=${ param.searchWord }'">
						</td>
					</tr>
