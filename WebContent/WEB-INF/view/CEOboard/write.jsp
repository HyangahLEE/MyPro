...
<jsp:include page="../main/navigator.jsp"/> 
  ...
  <!-- Page Content -->
	...
	<form action="ceo_write_ok.do" method="post">
	 <table width="600px" style="margin:50px auto" border="1">
	   
	   <tr>
	     <td width="70" align="center">작성자</td>
	     <td width="330">
	       <input type="text" name="ceo" size="12" value="mgId0001" >
	     </td>
	   </tr>
	   ...
	   <tr>
	     ...
	     <td width="330">
	       <textarea rows="13" cols="50" name="ceocontent"></textarea>
	     </td>
	   </tr>
	   ...
	   <tr>
	     <td colspan="2" align="center">
	       ...
	       <input type="button" value="글목록" onclick="location.href='ceo_list.do'">
	 	  </td>
	   </tr>
	 </table>
