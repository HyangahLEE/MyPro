...
<jsp:include page="../main/navigator.jsp"/> 
  ...
  <!-- Page Content -->
   ...
   <!--    Content Row -->
	...
	<form action="notice_write_ok.do" method="post">
	 <table width="600px" style="margin:50px auto" border="1">
	   ...
	   <tr>
	     ...
	     <td width="330">
	       <textarea rows="13" cols="50" name="ncontent"></textarea>
	     </td>
	   </tr>
	   <tr>
	   ...
	   <tr>
	     <td colspan="2" align="center">
	       ...
	       <input type="button" value="글목록" onclick="location.href='notice_list.do'">
	 	    </td>
	   </tr>
	 </table>
