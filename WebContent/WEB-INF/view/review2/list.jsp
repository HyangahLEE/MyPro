...
<script>
 $(function (){    
   $('#searchBtn').click(function (){
      $('form:first').attr('action','review2_list.do');
		...
		<div class="row">
			...
			<div class="col-lg-9 mb-4">
				...
				<div id="wrapper">
					...
					<!--탭 메뉴 영역 -->
					<ul class="tabs">
						<li><a href="review_list.do"">교육후기</a></li>
						<li><a href="review2_list.do" style="background-color: white">취업후기</a></li>
					</ul>
									...
									<c:if test="${ not empty list }">
										<c:forEach items="${ list }" var="dto">
											<tr align="center">
												...
												<td>${ dto.writer }</td>
												<td><a
													href="review2_view.do?num=${ dto.rid }&page=${currentPage }&searchCondition=${ param.searchCondition }&searchWord=${ param.searchWord }">${ dto.rtitle }</a>
												</td>
												<td>${ dto.rwritedt }</td>
												<td>${ dto.rreaded }</td>
									...
									<c:if
										...
										<div style="position: absolute; right: 10px;">
											<input type="button" value="글쓰기"
												onclick="location.href='review2_write.do?'" />
										</div>
									</c:if>
