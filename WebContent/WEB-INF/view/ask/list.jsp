...
<script>
 $(function (){    
   $('#searchBtn').click(function (){
      $('form:first').attr('action','ask_list.do');
		...
		<div class="row">
			...
			<div class="col-lg-9 mb-4">
				...
				<div id="wrapper">
					...
					<!--탭 메뉴 영역 -->
					<ul class="tabs">
						<li><a href="#tab1" style="background-color: white">취업교육</a></li>
						<li><a href="ask2_list.do">정규교육</a></li>
					</ul>
										...
										<c:forEach items="${ list }" var="dto">
											...
											<tr align="center">
												...
												<td><c:if test="${ dto.depth gt 0 }">
													...
													href="ask_view.do?num=${ dto.anum }&page=${currentPage }&searchCondition=${ param.searchCondition }&searchWord=${ param.searchWord }">${ dto.atitle }</a>
												</td>
									...
									<c:if
										...
										<div style="position: absolute; right: 10px;">
											<input type="button" value="글쓰기"
												onclick="location.href='ask_write.do?adid=adId0001'" />
										</div>
									</c:if>
