		...
		<div class="row">
         ...
         <td colspan="2" align="right">글보기</td>
					...
					<tr>
						...
						<td width="330">
							<div style="width: 100%; height: 200px;">${ dto.rcontent }
							</div>
						</td>
					</tr>
					...
					<tr>
						<td colspan="2" align="right"><c:if
								...
								<input type="button" value="글수정"
									onclick="location.href='review_edit.do?num=${ dto.rid }&page=${ param.page }&searchCondition=${ param.searchCondition }&searchWord=${ param.searchWord }'">

								<input type="button" id="btnModalDelete" class="btn btn-primary"
									data-toggle="modal" data-target="#exampleModalCenter"
									value="글삭제">
							</c:if> <input type="button" value="글목록"
							onclick="location.href='review_list.do?page=${ param.page }&searchCondition=${ param.searchCondition }&searchWord=${ param.searchWord }'">
						</td>
					</tr>
		...
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form id="form1" action="review_delete.do?num=${param.num }"
						method="post">
						<table width="300px" border="1" align="center">
							...
							<tr>
								<td><input type="submit" id="btnDelete" value="글삭제" /> <%-- <input type="button"  onclick="notice_list.do?page=${param.page }" id="btnList" value="글목록"/> --%>
									<a href="review_list.do?page=${param.page }">글목록</a>
