...
<jsp:include page="../main/navigator.jsp"/> 
  ...
  <!-- Page Content -->
      ...
      <div class="row">
        ...
        <!-- <div class="col-lg-3 mb-4">
          <div class="list-group">
            ...
            <a href="/intromain-3.do" class="list-group-item">취업정보</a>
	...
	<form action="ask2_edit_ok.do" method="post">
	 <table width="600px" style="margin:50px auto" border="1">
	   <tr>
	     <td colspan="2" align="right">
	       <a href="ask_list.do">글목록</a>
	     </td>
	   </tr>
	   <tr>
	     <td width="70" align="center">작성자</td>
	     <td width="330">
	       <input type="text" disabled="disabled" name="mgid" size="12" value="${ dto.writer }">
	       <input type="hidden" name="mgid" size="12" value="${ dto.writer }">
	     </td>
	   </tr>
	   <tr>
	   ...
	   <tr>
	     ...
	     <td width="330">
	       <textarea rows="13" cols="50" name="content" >${ dto.acontent }</textarea>
	     </td>
	   </tr>
	   <tr>
	     <td width="70" align="center">파일</td>
	     <td width="330">	      
	       <input  type="file" name="file" size="50" value='${ dto.afile }' > 
	   ...
	   <tr>
	     <td colspan="2" align="center">
	       ...
	       onclick="location.href='ask2_list.do?page=${ param.page }'">
	     </td>
	   </tr>
	 </table>
