					...
					<tr>
						...
						<c:if test="${ sessionScope.loginUser == dto.writer ||  not empty sessionScope.admin }">
								<input type="button" value="글수정"
									onclick="location.href='ask2_edit.do?num=${ dto.anum }&page=${ param.page }&searchCondition=${ param.searchCondition }&searchWord=${ param.searchWord }'">

								<input type="button" id="btnModalDelete" data-toggle="modal"
									data-target="#exampleModalCenter" value="글삭제">
							</c:if>
							 <input type="button" value="답글"
							onclick="location.href='ask2_write.do?num=${ dto.anum }&ref=${ dto.ref }&step=${ dto.step }&depth=${ dto.depth }&adid=${ dto.adid }'">
							<input type="button" value="글목록"
							onclick="location.href='ask2_list.do?page=${ param.page }&searchCondition=${ param.searchCondition }&searchWord=${ param.searchWord }'">
						</td>
					</tr>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
       <form id="form1" action="ask2_delete.do" method="post">
       <table width="300px" border="1" align="center">
                        ...
                        <tr>
                           ...
                           <a href="ask2_list.do?page=${param.page }" >글목록</a>
				...
				<div class="modal-body" style="text-align: center;">
					<form id="form1" action="ask2_delete.do" method="post">
						...
						<div style="float: right;">
							...
							<button id="btnList" type="button" onclick="location.href='ask2_list.do?page=${param.page }'" class="btn">글목록</button>
