...
public class IncumbentHandlerA implements CommandHandler {
    ...
    public String process(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        request.setAttribute("tpcost",TpNameDAO.getCost(conn, tpid));
        
        return "/WEB-INF/view/student/studentA.jsp";
    }
